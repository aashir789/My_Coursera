	...
	public static void main(String[] args) {
        ...
        */
        ...
        for(int i = 0; i<numOfPoints-1;i++) {
        	...
        	int subArraySize=numOfPoints-(i+1);

        	Point[] newPoints = new Point[subArraySize];
        	
        	for (int l=0;l<subArraySize;l++) {
        		newPoints[l]=points[(i+1)+l];
        	}

        	// #debug
        	//StdOut.println("Current point is: "+points[i].toString());
        	Arrays.sort(newPoints,points[i].SLOPE_ORDER);
